...
export function PrivacyPolicy() {
  return <LegalShell title="Privacy Policy" eyebrow={`Version ${PRIVACY_POLICY_VERSION} · Effective September 15, 2026`}>
    ...
    <section><h2>Retention and deletion</h2><p>Shift records are deleted after 12 months. Employee directory and profile records remain while an organization uses Floorly, unless an administrator deletes them or requests deletion. Encrypted backups expire within 30 days. Contact us for deletion or privacy requests; we verify authority before acting.</p></section>
