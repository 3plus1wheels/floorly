...
export const KRONOS_ERRORS = {
  ...
  WEEK_HEADERS_UNREADABLE: 'I found the Kronos grid, but could not identify dates in its column headers. The schedule layout may have changed.',
  NO_SHIFTS_EXTRACTED: 'I found schedule dates, but no readable shifts. The shift cells or job column may have changed.',
  SHIFT_DATA_UNREADABLE: 'I found shifts, but could not parse one of the dates, times, or jobs.',
  ...
  GRID_CAPTURE_FAILED: 'The Kronos grid changed while I was reading it. Reload Kronos and try again.',
